...
(function () {
    ...
    salary.detailedListing = (brutto, children = 0, supportedMembers = 0, surtaxPercentageDec = 0, city = 'zagreb', hours = 160, overtime = 0, vacation = 0, sickLeave = 0, sickLeave42 = 0, sickLeave80 = 0, sickLeave100 = 0, holiday = 0, nightShift = 0, co = 1.3, cv = 1, csl = 0.70, ch = 1, cn = 1.5) => {
        this.brutto = brutto;
        this.children = children;
        this.supportedMembers = supportedMembers;
        this.surtaxPercentageDec = surtaxPercentageDec;
        ...
        this.brutto = this.brutto + overtimeTotal + vacationTotal + sickLeaveTotal + sickLeave42Total + sickLeave80Total + sickLeave100Total + holidayTotal + nightShiftTotal;
